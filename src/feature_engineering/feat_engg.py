...
def generate_behavior_features(df):
    ...
    for user_id, group in grouped:
        ...
        row["avg_transaction_value"] = (
            group["transaction_amount"].mean()
        )

        row["max_transaction"] = (
            group["transaction_amount"].max()
        )

        row["total_spend"] = (
            group["transaction_amount"].sum()
        )
...
if __name__ == "__main__":
    ...
    features_df = generate_behavior_features(df)
